var jsPsychImageButtonResponseModified = (function (jspsych) {
  'use strict';

  var _package = {
    name: "@jspsych/plugin-image-button-response-modified-modified",
    version: "2.0.0",
    ...
    repository: {
      ...
      directory: "packages/plugin-image-button-response-modified-modified"
    },
    ...
    homepage: "https://www.jspsych.org/latest/plugins/image-button-response-modified",
    peerDependencies: {
      jspsych: ">=7.1.0"
    },
    devDependencies: {
  ...
  const info = {
    name: "image-button-response-modified",
    ...
    parameters: {
      ...
      /** Any content here will be displayed above the image. */
      upper_prompt: {
        type: jspsych.ParameterType.HTML_STRING,
        default: null,
      },
      /** Any content here will be displayed below the image. */
      prompt: {
        type: jspsych.ParameterType.HTML_STRING,
        default: null
      },
  ...
  class ImageButtonResponseModifiedPlugin {
    constructor(jsPsych) {
    ...
    trial(display_element, trial) {
      ...
      if (trial.upper_prompt !== null) {
        display_element.insertAdjacentHTML("beforeend", trial.upper_prompt);
      }
      ...
      stimulusElement.id = "jspsych-image-button-response-modified-stimulus";
      display_element.appendChild(stimulusElement);
      const buttonGroupElement = document.createElement("div");
      buttonGroupElement.id = "jspsych-image-button-response-modified-btngroup";
      ...
      function enable_buttons() {
        var btns = document.querySelectorAll(".jspsych-image-button-response-modified-button button");
      ...
      if (data.rt !== null) {
        this.jsPsych.pluginAPI.clickTarget(
          display_element.querySelector(
            `#jspsych-image-button-response-modified-btngroup [data-choice="${data.response}"]`
          ),
          data.rt
        );
      }
  ...
  return ImageButtonResponseModifiedPlugin;
