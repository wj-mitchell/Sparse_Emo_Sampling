      ...
      trial(display_element, trial) {
          ...
          html +=
              ".jspsych-survey-likert-statement { display:block; font-size: 16px; padding-top: 40px; margin-bottom:10px; }" +
                ...
                //   MODIFIED - this line controls the height of the likert scale
                  ".jspsych-survey-likert-opts:before { content: ''; position:relative; top:11px; margin-bottom: -7px; /*left:9.5%;*/ display:block; background-color:#efefef; height:15px; box-shadow: 0px 0px 0px #000000, 0px 0px 0px #0d0d0d; border-radius: 6px; border: 2px solid #aaa; width:100%; }" +
                  ".jspsych-survey-likert-opts:last-of-type { border-bottom: 0; }" +
                  ".jspsych-survey-likert-opts li { display:inline-block; /*width:19%;*/ text-align:center; vertical-align: top; }" +
                //   MODIFIED - this line controls the height of the radio buttons
                  ".jspsych-survey-likert-opts li input[type=radio] { display:block; transform: scale(3); margin-bottom: 20px; position:relative; left:50%; margin-left:-6px; }";
          html += "</style>";
          // show preamble text
          ...
          for (var i = 0; i < trial.questions.length; i++) {
              ...
              //   MODIFIED - these lines add an image
                if (trial.stimulus != undefined){
                    html += '<div id="jspsych-survey-likert-stimulus">';
